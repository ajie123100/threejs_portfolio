...
const Projects = () => {
    ...
    return (
        <section className="c-space my-20">
            <p className="head-text">我的工作</p>

            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200">
                    <div className="absolute top-0 right-0">
                        <img src={myProjects[0].spotlight} alt="spotlight" className="object-contain w-full h-96 rounded-xl" />
                    </div>
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-5">
                        ...
                        <a href={currentProject.href} target="_blank" rel="noreferrer" className="flex items-center gap-2 cursor-pointer text-slate-600">
                            <p>Check Live Site</p>
